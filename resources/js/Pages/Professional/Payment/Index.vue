...
<template>
    <!-- Header -->
    <Head title="Professional Payment Show" />
    <!--/ Header -->
                                    ...
                                    <table class="table-auto sm:rounded-md w-full text-sm text-left text-gray-500 dark:text-gray-400 border-collapse border-b border-gray-400">
                                        ...
                                        <tbody>
                                            <tr v-for="(appointment, index) in appointments.data" :key="appointment.id"
                                                ...
                                                <td data-label="Title" class="py-4 px-6">
                                                    <Link :href="route('events.show', appointment.event_id)" class="font-semibold">{{ appointment.event_title }}</Link>
                                                </td>
                                                ...
                                                <td data-label="Action" class="py-4 px-6">
                                                    <Link v-if="can.edit && appointment.payment.status == 'succeeded'" :href="route('appointment.show', appointment.id)"
                                                    ...
                                                    <Link v-else-if="can.edit" :href="route('payment.create', appointment.id)"
