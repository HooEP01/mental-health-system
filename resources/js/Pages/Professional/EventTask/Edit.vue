...
export default {
    ...
    setup(props) {
        ...
        let theContent = ref(props.theContent);
        let addContent = ref(true);
        ...
        function submit() {
            ...
            Inertia.post(route('events.tasks.store', form.event_id), form);
        };
    ...
    methods: {
        ...
        back(value){
            ...
            Inertia.get(route('events.show', [value, {tab: tab}])); 
        }
    }
}
    ...
    <BreezeAuthenticatedLayout>
        ...
        <template #content>
            ...
            <ContainerWithSideBar>
                ...
                <template #feature>
                    <li class="flow-root">
                        <Link @click="back(event.id)" class="inline-flex items-center text-left w-full fill-white bg-indigo-500 hover:bg-indigo-600 text-white font-semibold py-3 px-4 border border-transparent rounded">
                            <box-icon class='mr-2' name='arrow-back'></box-icon> <span class="inline-block align-top">Back To Event</span>
                        </Link>
                    </li>
                </template>
                <!--/ #Feature -->
                                ...
                                <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <div v-if="addContent" class="mt-4">
                                                ...
                                                <ContentTaskEditor v-model="theContent" :contents="contents" :event="event" :index="index" :isAppointment=false />
                                            </div>
                                        </div>
                                    </div>
                                    <!--/ Content -->
                                    ...
                                    <div class="px-4 py-3 text-right">
                                        <button type="submit" class="inline-flex justify-center rounded-md border border-transparent fill-white bg-indigo-500 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-600">
                                            <box-icon class='mr-2' name='cube'></box-icon> 
                                            <span class="inline-block align-top text-base mr-2">Save The Event Task</span>
                                        </button>
                                    </div>
                                    <!--/ Submit -->
